...
// Function to add documents in batch to the FlexSearch Document index
...
//         // Add the new document to the conversations list
//         conversations_doc.push(newDocument);

//         // Add document to FlexSearch document index
//         index_doc.add(newDocument);
